...
<form class="bkground-content animate" action="includes/students_login.inc.php" method="post">
    <div class="imgcontainer">
      ...
      <img src="https://clip-art-guru.info/wp-content/uploads/2018/02/diploma-pictures-clip-art-14001191331051495898graduation-cap-and-diploma-hi.jpg" alt="Avatar" class="avatar">
    </div>
    ...
    <label for="mailuid"><b>Username/E-mail</b></label><br>
     ...
     <div class="container" style="background-color:#ffca64">          
      <span class="psw"; style="font-weight: bold"> <a href="PasswordReset.html">Forgot password?</a></span>
